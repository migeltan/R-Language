...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
# # 4. Univariate Analysis: Legal Age Pie Chart
# # Question: How many students are at the legal age (18+)?
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 

age_data <- data.frame(
  category = c("18 and above", "Below 18"),
  value = c(85, 15)
)

ggplot(age_data, aes(x = "", y = value, fill = category)) +
  geom_bar(stat = "identity", width = 1, color = "white") +
  coord_polar("y", start = 0) +
  scale_fill_manual(values = c("skyblue", "darkblue")) +
  theme_void() +
  labs(title = "Age (18+ vs <18)") +
  geom_text(aes(label = paste0(category, " ", value, "%")), 
            position = position_stack(vjust = 0.5))


# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
# # 5. Univariate Analysis: Weekly Social Activities Histogram
# # Question: What's the average number of weekly social activities attended by 80,000 students?
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 

set.seed(123)
social_data <- data.frame(activities = runif(80000, 0, 5))

ggplot(social_data, aes(x = activities)) +
  geom_histogram(binwidth = 0.8, fill = "skyblue", color = "steelblue") +
  theme_minimal() +
  labs(title = "Weekly Social Activities Attended by Students",
       x = "Social Activities per Week",
       y = "Number of Students")


# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
# # 6. Univariate Analysis: Dropout Risk Pie Chart
# # Question: How many students are likely to drop out?
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
# # 4. Bivariate Analysis: Scatter Plot Matrix
# # Question: How does motivation_level and exam_anxiety_score directly impact exam_score?
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
# # 5. Bivariate Analysis: Faceted Box Plot
# # Question: How does major relate to sleep_hour and mental_health_rating?
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
